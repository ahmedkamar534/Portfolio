...
(function ($) {
    ...
    jQuery(document).on('ready', function () {
        ...
        function initBackgroundOptions() {
            $('body,.timeline-image,.project-preview,.gear-preview,.whats-hot-preview,.screenshot-preview,.product-preview,.services-image,.details-image,.desktop,.swiper-slide,.about-image,.feature-image,.place-preview-image,.coming-preview,.error-preview,.clients-block,.gallery-preview,.bg-data-call').each(function () {
